...
import {
  ...
  usePriorityValues,
  useSimpleLocale,
} from '@saas-core/composables';
import { X } from '@saas-core/icons';
import {
  SaasButton,
  SaasHelpTooltip,
  SaasIconButton,
...
import { ELEMENT_ID_MAIN_CONTENT } from '@saas-core/shared/constants';
  ...
  >
    ...
    >
        ...
        <div>
          <SheetTitle v-if="title" class="text-left">
            <slot name="title">
              ...
              <SaasHelpTooltip v-if="titleTooltip" trigger-class="pb-1">
                {{ titleTooltip }}
              </SaasHelpTooltip>
            </slot>
          </SheetTitle>
      ...
      <div
        ...
        "
      >
        <SaasLoading v-if="showLoading" class="size-full" spinning />
      ...
      >
        ...
        <slot name="footer">
          <component
            :is="components.DefaultButton || SaasButton"
          ...
          <component
            :is="components.PrimaryButton || SaasButton"
