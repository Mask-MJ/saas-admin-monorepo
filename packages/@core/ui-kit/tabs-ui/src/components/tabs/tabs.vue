...
import type { TabDefinition } from '@saas-core/typings';

import type { TabConfig, TabsProps } from '../../types';

import { computed } from 'vue';

import { Pin, X } from '@saas-core/icons';
import { SaasContextMenu, SaasIcon } from '@saas-core/shadcn-ui';
...
const props = withDefaults(defineProps<Props>(), {
  contentClass: 'saas-tabs-content',
  contextMenus: () => [],
  tabs: () => [],
});
